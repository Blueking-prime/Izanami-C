...
default_skills = [
    Offensive_Skill(
        ...
        stat_multiplier= 3,
        cost=15,
        flavour_text="You spend your pent up energy and swing with gusto, dealing ${POW} damage"
    )
]
...
ronin_skills = [
    Offensive_Skill(
        ...
        cost=24,
        boost=(1, 0.5),
        flavour_text="Letting go of your guard, ignorant of all defense, you put your very soul into one devastating swing, dealing ${POW} damage"
    ),
    Offensive_Skill(
        'Moon Swallow',
        stats=['STR'],
        stat_multiplier= 2,
        cost=10,
        flavour_text="Channeling the power of the moon you perform a dazzling strike, dealing ${POW2} damage",
